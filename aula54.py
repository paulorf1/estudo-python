...
# Listas ([]): Estrutura de dados fundamental para armazenar uma coleção ordenada de itens

# Loop while: Para repetir um bloco de código

# Entrada do Usuário (input()): Para tornar o programa interativo

# Condicionais (if/elif/else): Para tomar decisões com base na entrada do usuário

# Tratamento de Exceções (try/except): Essencial para criar programas robustos que não quebram com entradas inesperadas ou erros de lógica

# Função enumerate(): A melhor maneira de iterar sobre uma lista quando você precisa tanto do índice quanto do valor do item

# Módulo os: Para interagir com o sistema operacional (neste caso, para limpar a tela)